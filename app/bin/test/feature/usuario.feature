...
Funcionalidade: Gerenciamento de um usuario na Petstore
  ...
  Cenario: Cria um usuario na loja
    Quando faco um POST para /v3/user com os seguintes valores:
      ...
      | phone      | 12345          |
      | userStatus | 1              |
    Entao quando faco um GET para /user/theUser, o usuario e criado

  Cenario: Cria um usuario na loja usando docstring
    Quando faco um POST para /user com os seguinte docstring:
    """json
      {
    "id": 10,
    "username": "theUser",
    ...
    """
    Entao quando faco um GET para /user/theUser, o usuario criado e retornado
